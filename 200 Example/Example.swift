...
final class Example: Identifiable {
    ...
    static let table: [Example] = [
        ...
        Example(title: "SwiftUI, Form 2",
                relativePath: "SwiftUI/Form/FormExample2.swift",
                category: .swiftUI,
                makeView: { AnyView(FormExample2()) } ),
        Example(title: "SwiftUI, OnChange",
                relativePath: "SwiftUI/State/OnChangeExample.swift",
                category: .swiftUI,
                makeView: { AnyView(OnChangeExample()) } ),
        Example(title: "SwiftUI, OnChange 2",
                relativePath: "SwiftUI/State/OnChangeExample2.swift",
                category: .swiftUI,
                makeView: { AnyView(OnChangeExample2()) } ),
        ...
        Example(title: "Swift, DidSet",
                relativePath: "Swift/DidSet/DidSetExample.swift",
                category: .swiftUI,
                makeView: { AnyView(DidSetExample()) } ),
    ]
}
